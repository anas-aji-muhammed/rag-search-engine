...
from lib.keyword_search import (
    ...
    idf_command,
    search_command,
    tf_command, tfidf_command, bm25_idf_command, bm25_tf_command, bm25search_command,
)
...
def main() -> None:
    ...
    tfidf_parser = subparsers.add_parser(
        "tfidf", help="TF-IDF (Term Frequency-Inverse Document Frequency)"
    )
    ...
    match args.command:
        ...
        case "tfidf":
            tf_idf = tfidf_command(args.term,args.doc_id)
